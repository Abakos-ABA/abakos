...
// Abakos fork: use the local rebranded chain-sdk (abakos bech32 prefix, uaba denom).
replace pkg.akt.dev/go => ../chain-sdk/go
...
replace (
	...
	// Cosmos EVM (cosmos/evm v0.5.1): use the Cosmos geth fork + gin security pin
	...
	// use akash fork of cosmos sdk, vendored locally as an in-repo fork that adds
	// SetBaseDenom (removed by akash, required by Cosmos EVM x/vm). See cosmos-sdk/.
